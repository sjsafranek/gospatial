$(function(){
  ...
  $('.bs-docs-section').each(function() {
    ...
    if (h1.length) {
      ...
      // stefan safranek --> add 'page-scroll' class for slow scroll
      html+= '<li><a href="#' + h1[0].id +'" class="page-scroll">'+ h1.clone().children().remove().end().text() +'</a>';
      ...
      if (h23.length) {
        ...
        h23.each(function() {
          ...
          // stefan safranek --> add 'page-scroll' class for slow scroll
          html+= '<li><a href="#' + this.id +'" class="page-scroll">'+ $(this).clone().children().remove().end().text() +'</a></li>';
        });
        html+= '</ul>';
      }
